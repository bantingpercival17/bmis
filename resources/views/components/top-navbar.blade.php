<nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-2">
        <nav aria-label="breadcrumb">
            <small class="font-weight-bold mb-0">@yield('page-title')</small>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item ps-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="../assets/img/team-2.jpg" class="avatar avatar-sm" alt="avatar" />
                    </a>
                    <ul class="m-0 dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button style="background:none;border:none;outline:none;box-shadow:none;" type="submit" class="sidebar-link waves-effect waves-dark sidebar-link">
                                                <h6 class="text-sm font-weight-normal mb-1">
