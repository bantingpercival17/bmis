                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="searchInput" wire:keydown="selectAddress"
                    ...
                    <div class="card-body">
                        ...
                        <form wire:submit.prevent="updateInformation" method="post" class="mt-2">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-3 col-md-12">
                                    ...
                                    <input wire:model="residents.last_name" type="text"
                                        class="form-control border border-info" {{ $input }}>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    <small class="text-secondary ">CIVIL STATUS <span
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6 col-md-12">
                                    <small class="text-secondary ">BIRTH PLACE <span
                                            class="text-danger">*</span></small>
                        ...
                        @if ($addressForm)
                            <div class="form mb-5">
                                ...
                                <form wire:submit.prevent="storeAddress" method="post" class="mt-2">
                                    <div class="row">
                                        <div class="form-group col-lg-4 col-md-12">
                                            <small class="text-secondary ">REGION <span
                                                    class="text-danger">*</span></small>
                                            <select wire:change="selectAddress" wire:model="address.region"
                                        ...
                                        <div class="form-group col-lg-4 col-md-12">
                                            <small class="text-secondary ">PROVINCE <span
                                                    class="text-danger">*</span></small>
                                            <select wire:model="address.province"
                                        ...
                                        <div class="form-group col-lg-4 col-md-12">
                                            <small class="text-secondary ">MUNICIPALITY / CITY <span
                                                    class="text-danger">*</span></small>
                                            <select wire:model="address.municipality" wire:change="selectAddress"
                                                class="form-select border border-info">
                                        ...
                                        <div class="form-group col-lg-4 col-md-12">
                                            <small class="text-secondary ">BARANGAY<span
                                                    class="text-danger">*</span></small>
                                            <select wire:model="address.barangay" wire:change="selectAddress"
                                                class="form-select border border-info">
