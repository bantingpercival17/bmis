    ...
    <div class="container-fluid">
        <div class="card  border border-soft-info">
            <div class="card-header bg-white">
                <span class="text-info fw-bolder h3"><b>Resident's Information Form</b></span>
            </div>
            <div class="card-body">
                <form wire:submit.prevent="submitForm" method="post" class="mt-2">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-3 col-md-12">
                            ...
                            <input wire:model="residents.last_name" type="text" class="form-control border border-info">
                        ...
                        <div class="form-group col-lg-3 col-md-12">
                            ...
                            <input wire:model="residents.first_name" type="text" class="form-control border border-info">
                        ...
                        <div class="form-group col-lg-3 col-md-12">
                            ...
                            <input wire:model="residents.middle_name" type="text" class="form-control border border-info">
                        ...
                        <div class="form-group col-lg-3 col-md-12">
                            ...
                            <input wire:model="residents.extension_name" type="text" class="form-control border border-info">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-12">
                            ...
                            <input wire:model="residents.birth_date" type="date" class="form-control border border-info">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6 col-md-12">
                            ...
                            <input wire:model="residents.birth_place" type="text" class="form-control border border-info">
                        ...
                        <div class="form-group col-lg-6 col-md-12">
                            ...
                            <input wire:model="residents.contact_number" type="text" class="form-control border border-info">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-12">
                            ...
                            <select wire:change="selectAddress" wire:model="residents.region" class="form-select border border-info">
                        ...
                        <div class="form-group col-lg-4 col-md-12">
                            ...
                            <select wire:model="residents.province" wire:change="selectAddress" class="form-select border border-info">
                        ...
                        <div class="form-group col-lg-4 col-md-12">
                            ...
                            <select wire:model="residents.municipality" wire:change="selectAddress" class="form-select border border-info">
                        ...
                        <div class="form-group col-lg-4 col-md-12">
                            ...
                            <select wire:model="residents.barangay" wire:change="selectAddress" class="form-select border border-info">
                        ...
                        <div class="form-group col-lg-8 col-md-12">
                            ...
                            <input wire:model="residents.street" type="text" class="form-control border border-info">
