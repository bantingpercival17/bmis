                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="findResident" wire:keydown="auto" class="form-control form-control-sm border border-primary" placeholder="Search Pattern: Last Name, First Name">
                        </div>
                        @if ($filter)
                        <div class="form-group">
                            <small class="text-secondary ">GENDER</small>
                            <select wire:change="selectAddress" wire:model="filter.gender" class="form-select form-select-sm border border-primary">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:change="selectAddress" wire:model="filter.civil_status" class="form-select form-select-sm border border-primary">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:change="selectAddress" wire:model="filter.age_group_name" class="form-select form-select-sm border border-primary">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:change="selectAddress" wire:model="residents.region" class="form-select form-select-sm border border-primary">
                            ...
                            <small class="badge border border-danger text-danger bg-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            <small class="text-secondary ">PROVINCE <span class="text-danger">*</span></small>
                            <select wire:model="residents.province" wire:change="selectAddress" class="form-select form-select-sm border border-primary">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model="residents.municipality" wire:change="selectAddress" class="form-select form-select-sm border border-primary">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model="residents.barangay" wire:change="selectAddress" class="form-select form-select-sm border border-primary">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('barangay-clearance.view') . '?resident=' . base64_encode($resident->id) }}">
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ $resident->profile() }}" class="avatar avatar-sm rounded-circle me-2" alt="user1">
                                                </div>
                ...
                <div class="card mb-2">
                    <div class="row no-gutters">
                        <div class="col-md-3">
                            ...
                            @else
                            <img src="{{ asset('assets/img/avatar.png') }}" class="card-img" alt="resident-image">
                            @endif
                        ...
                        <div class="col-md ps-0">
                            <div class="card-body p-3 me-2">
                                ...
                                <p class="mb-0">
                                    <small class="fw-bolder badge  border border-success text-success bg-success border-radius-sm mt-auto mb-2">
                        ...
                        <form wire:submit.prevent="submitForm" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <input wire:model="clearance.occupation" type="text" class="form-control border border-info">
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <input wire:model="clearance.length_of_residency" type="number" class="form-control border border-info">
                            ...
                            <label for="" class="fw-bolder text-info h6">{{ strtoupper('Identification Details') }}</label>
                            <div class="row">
                                <div class="form-group col-lg-4 col-md-12">
                                    <small class="text-muted fw-bolder">
                                        {{ strtoupper('id type') }}
                                    ...
                                    <select wire:model="clearance.identification_id_type" class="form-select border border-info">
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <input wire:model="clearance.identification_issuing_agency" type="text" class="form-control border border-info">
                                ...
                                <div class="form-group col-lg-4 col-md-12">
                                    ...
                                    <input wire:model="clearance.identification_id_number" type="text" class="form-control border border-info">
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" href="{{ route('report.barangay-clearance') . '?bc=' . base64_encode($issued->id) }}" class="btn btn-outline-success btn-sm">PRINT</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex align-items-center">
                                                    <img src="{{$issued->resident->profile()}}" class="avatar avatar-sm rounded-circle me-2" alt="user1">
                                                </div>
                                                <div class="d-flex flex-column justify-content-center ms-1">
                                                    <h6 class="mb-0 text-sm font-weight-semibold">
