                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:change="selectAddress" wire:model="filter.gender" class="form-select border border-info">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:change="selectAddress" wire:model="filter.civil_status" class="form-select border border-info">
                        ...
                        <div class="form-group">
                            ...
                            <select wire:change="selectAddress" wire:model="filter.age_group_name" class="form-select border border-info">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group text-end">
                            <label for="" class="text-muted fw-bolder">Result: <span class="text-info fw-bolder">{{ count($residentLists) }}</span></label>
                        </div>
                        <div class="table-responsive">
                            <table class="table stylish-table no-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width:50px;"><span class="round">{{ $resident->first_name[0] }}</span></td>
                                        ...
                                        <td class="align-middle">
                                            <div class="row">
                                                <div class="col-md">
                                                    <a href="{{ route('resident.view', base64_encode($resident->id)) }}" class="btn btn-primary">View</a>
                                                </div>
                                            </div>
                                        </td>
